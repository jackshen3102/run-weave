...
describe("applyInputToPage", () => {
  it("applies mouse click and move events", async () => {
    ...
    await applyInputToPage(page as never, { type: "mouse", action: "move", x: 12, y: 18 });
    await applyInputToPage(page as never, { type: "mouse", action: "click", x: 15, y: 20, button: "right" });
