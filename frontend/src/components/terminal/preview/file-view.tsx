...
import { TerminalFileExplorer } from "./file-explorer";
import { TerminalOpenFileCommand } from "./open-file-command";
import type { UseTerminalFileTreeReturn } from "./use-file-tree";
...
const TerminalMonacoViewer = lazy(() =>
  import("./monaco-viewer").then((module) => ({
