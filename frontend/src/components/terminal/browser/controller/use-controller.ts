...
import { useTerminalBrowserAnnotations } from "../annotations/use-annotations";
import { useTerminalBrowserDisplayScale } from "../device/use-display-scale";
import { useTerminalBrowserViewport } from "./use-viewport";
import { useTerminalBrowserWorkspaceActions } from "./use-workspace-actions";
import { useTerminalBrowserProfileResolution } from "../header/use-profile";
import { useTerminalBrowserControllerStore } from "./use-store";
import type { TerminalBrowserControllerOptions } from "./types";
import {
