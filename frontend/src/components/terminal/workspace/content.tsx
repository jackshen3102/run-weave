...
export type { TerminalWorkspaceProps } from "./types";
...
export function TerminalWorkspaceContent({
  ...
  const {
    ...
    useShallow((state) => ({
      ...
      setActiveParentProjectId: state.setActiveParentProjectId,
      selectProjectContext: state.selectProjectContext,
      setActiveSessionId: state.setActiveSessionId,
      setTerminalStateBySessionId: state.setTerminalStateBySessionId,
      setCompletionMarkers: state.setCompletionMarkers,
      setBellMarkers: state.setBellMarkers,
      setCachedSurfaceSessionIds: state.setCachedSurfaceSessionIds,
      ...
      selectActiveSession: state.selectActiveSession,
      resetWorkspaceForConnection: state.resetForConnection,
    })),
  );
