...
// For existing custom dialog layouts; owns the same native-layer registration.
export const DialogSurface = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>
>((props, ref) => {
  const overlayRef = useOverlayRef(ref);
  return <DialogPrimitive.Content {...props} ref={overlayRef} />;
});
