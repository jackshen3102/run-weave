...
模拟器安装前先按[共享设备池](../../docs/cli/ios-simulators.md)以随记 App 身份申请设备，两个槽位均可使用；整个验证任务共用 task-dir，run 使用当前源码增量构建并核对安装，任务结束执行 finish。
