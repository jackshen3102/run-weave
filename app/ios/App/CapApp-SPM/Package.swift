...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorLocalNotifications", path: "../../../../node_modules/.pnpm/@capacitor+local-notifications@8.3.1_@capacitor+core@8.4.0/node_modules/@capacitor/local-notifications"),
