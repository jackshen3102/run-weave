...
这份文档用于把 `https://www.coze.cn` 的页面流量转到当前 Browser Profile
...
includeFilter://m:get
excludeFilter://www.coze.cn/api/
excludeFilter://www.coze.cn/vibe/
excludeFilter://www.coze.cn/s/
excludeFilter://www.coze.cn/passport/
excludeFilter://www.coze.cn/sign
excludeFilter://www.coze.cn/auth/callback
excludeFilter://www.coze.cn/v1/api/
excludeFilter://www.coze.cn/base-agent/api/
`

line`
^wss://www.coze.cn:*/rsbuild-hmr
host://{runweave-dev-server}
`
```
...
- `^wss://www.coze.cn:*/rsbuild-hmr` 能匹配 Rsbuild 生成的带端口 WSS 地址，
  例如 `wss://www.coze.cn:3000/rsbuild-hmr`。
...
```text
www.coze.cn/rsbuild-hmr
```

Whistle 2.10.9 不会用它匹配 `wss://www.coze.cn:<port>/rsbuild-hmr`。
