...
Desktop App、Desktop Runtime 与 App Server 的更新参数和操作步骤统一维护在
[本地更新指南](../deployment/electron-local-updates.md#app-server-组件更新)。
本页的 install/start/restart 描述单个 App Server owner 的操作边界，不复制桌面更新器流程。
