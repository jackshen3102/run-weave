...
- 原型目录：[docs/prototypes/terminal-panel-split](../prototypes/terminal-panel-split/)
- 原型说明：[README.md](../prototypes/terminal-panel-split/README.md)
- 原型截图：[prototype-preview.png](../prototypes/terminal-panel-split/prototype-preview.png)
