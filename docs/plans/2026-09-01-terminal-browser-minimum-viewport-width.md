...
> 配套测试计划：`docs/testing/terminal/terminal-browser-minimum-viewport-width.testplan.yaml`
...
- `electron/src/terminal-browser-network.ts`
- `electron/src/terminal-browser-profile-runtime.ts`
- `frontend/src/components/terminal/browser/profile-status.tsx`
...
- `packages/shared/src/terminal-browser-workspace.ts`
...
- `electron/src/terminal-browser-view-attachment.ts`
- `electron/src/terminal-browser-view-helpers.ts`
...
- `frontend/src/components/terminal/browser/use-controller.ts`
- `frontend/src/components/terminal/browser/use-bounds.ts`
- `frontend/src/components/terminal/browser/surface.tsx`
- `frontend/src/components/terminal/browser/navigation-bar.tsx`
...
新增 `packages/shared/src/terminal-browser-minimum-width.ts`，并在 `package.json#exports` 与
...
在 `electron/src/terminal-browser-display-scale.ts` 中把 minimum 作为与 automation/mobile/displayScale 同级的
...
- `packages/shared/src/terminal-browser-minimum-width.ts`
- `frontend/src/components/terminal/browser/use-minimum-viewport-width.ts`
...
- `frontend/src/features/terminal/preview-store-types.ts`
- `frontend/src/features/terminal/preview-browser-slice.ts`
- `frontend/src/components/terminal/browser/model.ts`
...
- `electron/src/terminal-browser-viewport-layout.ts`
...
- `docs/architecture/terminal-code-preview.md`
- `docs/testing/terminal/terminal-browser-minimum-viewport-width.testplan.yaml`
...
```bash
pnpm testplan:validate docs/testing/terminal/terminal-browser-minimum-viewport-width.testplan.yaml
