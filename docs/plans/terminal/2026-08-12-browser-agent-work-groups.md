...
> 配套测试计划：`docs/testing/terminal/browser/agent-work-groups.testplan.yaml`
...
- `electron/src/browser/tabs/index.ts`
- `electron/src/browser/tabs/state.ts`
...
新增 `packages/shared/src/browser/workspace.ts`，并从 package exports 与 `src/index.ts` 导出：
...
`electron/src/browser/runtime.ts` 增加每窗口 workspace 元数据：
...
建议新建 `electron/src/browser/workspace/index.ts`，集中负责：
...
建议新增 `electron/src/browser/favicon.ts`：
...
- `packages/shared/src/browser/workspace.ts`（新增）
- `packages/shared/src/desktop/bridge.ts`
...
- `electron/src/browser/workspace/index.ts`（新增）
- `electron/src/browser/runtime.ts`
- `electron/src/browser/tabs/index.ts`
- `electron/src/browser/view/lifecycle.ts`
- `electron/src/browser/proxy/api.ts`
- `electron/src/browser/handlers.ts`
- `electron/src/browser/cdp/proxy/messages.ts`
...
- `electron/src/browser/tabs/state.ts`
- `electron/src/browser/tabs/persistence.ts`
- `electron/src/browser/tabs/index.ts`
- `electron/src/browser/view/lifecycle.ts`
...
- `electron/src/browser/favicon.ts`（新增）
- `electron/src/browser/runtime.ts`
- `electron/src/browser/view/lifecycle.ts`
...
- `docs/testing/terminal/browser/agent-work-groups.testplan.yaml`
...
```bash
pnpm testplan:validate docs/testing/terminal/browser/agent-work-groups.testplan.yaml
