...
- `backend/src/terminal/workspace-service/worktree-project-registry.ts`（新增）
- `backend/src/routes/terminal/projects/context.ts`（新增）
- `backend/src/terminal/manager-base.ts`
- `backend/src/terminal/manager.ts`
- `backend/src/bootstrap/runtime-services.ts`
- `backend/src/routes/terminal/index.ts`
- `frontend/src/services/terminal/index.ts`
- `frontend/src/features/terminal/queries/keys.ts`
- `frontend/src/features/terminal/queries/workspace.ts`
...
- `backend/src/routes/terminal/sessions/helpers.ts`
- `backend/src/routes/terminal/preview/index.ts`
...
- `backend/src/routes/terminal/preview/gallery.ts`
- `backend/src/routes/terminal/projects/index.ts`
- `backend/src/terminal/manager.ts`
- `backend/src/terminal/lowdb-store.ts`
...
- `frontend/src/features/terminal/state/workspace-store.ts`
- `frontend/src/features/terminal/input/recent-selection.ts`
