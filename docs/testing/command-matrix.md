...
| 终端链路 / Vim / 预览     | 对应 package typecheck/lint 后，按 `terminal-state-test-cases.md`、`runbooks/terminal-vim.md`、Preview 对应用例使用 `$playwright-cli` 真实验收                                                                    |
...
| Web 日志上报入口          | frontend/backend typecheck/lint 后，按 `docs/quality/ai-diagnostic-logging.md` 使用 `$playwright-cli` 真实验收                                                                                                    |
