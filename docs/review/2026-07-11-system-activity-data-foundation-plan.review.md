...
> **状态：已失效，仅作历史评审记录。** 本报告评审的是旧版“独立 Activity Hub daemon”方案；该方案已于 2026-07-11 被整体替换为“现有 Backend 内嵌 ActivityStore、多 Backend 共享 OS 用户级 SQLite”。当前实施依据只看 `docs/plans/2026-07-11-system-activity-data-foundation.md` 与配套测试文档，以下 Activity Hub 相关问题不再代表当前计划。
