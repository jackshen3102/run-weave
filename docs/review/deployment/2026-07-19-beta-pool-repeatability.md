...
- 定位：`scripts/update/core.mjs:57`、`scripts/update/core.mjs:136`、`scripts/dev-session/beta-pool/storage/paths.mjs:30`、`scripts/dev-session/beta-pool/core.mjs:447`。
...
- 定位：`scripts/dev-session/cli.mjs:368`、`scripts/dev-session/cli.mjs:388`、`scripts/dev-session/commands/start-cleanup.mjs:57`、`scripts/dev-session/beta-pool/lifecycle.mjs:115`、`scripts/dev-session/beta-pool/lifecycle.mjs:147`、`scripts/dev-session/beta-pool/lifecycle.mjs:234`。
...
- 定位：`scripts/beta/index.mjs:181`、`scripts/beta/index.mjs:188`、`scripts/beta/index.mjs:222`、`scripts/update/operations.mjs:305`。全仓搜索 `pendingPath` 仅发现写入和删除，没有恢复读取。
