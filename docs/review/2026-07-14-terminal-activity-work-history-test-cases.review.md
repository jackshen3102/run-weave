...
测试案例文档可解析且具备基本可追溯性：当前 Agent Team run 已从 `docs/testing/terminal/terminal-activity-work-history-test-cases.md` 加载 AGT-WH-001 至 AGT-WH-024，并保存 `sourceFilePath`、`sourceHeading` 与生成文件 SHA-256。现有用例覆盖 Terminal/Run 档案、Thread detail、降级、分页、Round 归属、鉴权和旧 Activity 回归，主体结构成立。
...
- 定位：`docs/testing/terminal/terminal-activity-work-history-test-cases.md:72`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:820`；当前 run 的 behavior worker 也只绑定该文件，见 `.runweave/agent-team/atr_f4741241_20260713184034.json:99`。
...
- 定位：`docs/testing/terminal/terminal-activity-work-history-test-cases.md:197`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:211`；计划也只写“稳定类型优先级”，见 `docs/plans/2026-07-13-terminal-activity-work-history.md:372`。
...
- 定位：`docs/testing/terminal/terminal-activity-work-history-test-cases.md:403`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:411`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:419`；计划只给出范围，见 `docs/plans/2026-07-13-terminal-activity-work-history.md:178`。
...
- 定位：`docs/plans/2026-07-13-terminal-activity-work-history.md:349`、`docs/plans/2026-07-13-terminal-activity-work-history.md:352`；`docs/testing/terminal/terminal-activity-work-history-test-cases.md:103`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:432`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:449`。
...
- 定位：`docs/plans/2026-07-13-terminal-activity-work-history.md:180`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:227`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:260`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:599`。
...
- 定位：`docs/plans/2026-07-13-terminal-activity-work-history.md:45`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:374`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:382`。
...
- 定位：`docs/testing/terminal/terminal-activity-work-history-test-cases.md:260`、`docs/testing/terminal/terminal-activity-work-history-test-cases.md:290`；环境约束见 `docs/testing/terminal/terminal-activity-work-history-test-cases.md:41`。
