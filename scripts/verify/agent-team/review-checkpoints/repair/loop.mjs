...
import { createActiveWorkerDispatch } from "../../../../../backend/src/agent-team/service/policies/workflow.ts";
import { buildFixVerification, buildRepairEvidence, buildRepairRun, normalizeRepairOutbox } from "./fixtures.mjs";
import { verifyReviewStartupPromptUsesExplicitGate } from "../review-gate-prompt.mjs";
import { verifyRepairLoopContinuation } from "./loop-continuation.mjs";
import { verifyFindingDispositionChecks } from "./loop-finding-disposition.mjs";
...
export function verifyEvidenceGatedRepairLoop(check) {
  const executionSource = readFileSync(
    new URL(
      "../../../../../backend/src/agent-team/service/execution/index.ts",
      import.meta.url,
    ),
    "utf8",
  );
  ...
  const completionSource = readFileSync(
    new URL(
      "../../../../../backend/src/agent-team/service/completion/index.ts",
      import.meta.url,
    ),
    "utf8",
  );
  ...
  const workerDispatchSupportSource = readFileSync(
    new URL(
      "../../../../../backend/src/agent-team/service/execution/worker-dispatch.ts",
      import.meta.url,
    ),
    "utf8",
  );
