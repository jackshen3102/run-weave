...
export const INSTALLED_APP_CONTROL_PATH_PREFIXES = [
  ...
  "scripts/electron/publish-local-updates.mjs",
  "scripts/update/",
  "scripts/beta/index.mjs",
  "scripts/electron/serve-local-updates.mjs",
];
...
export { parseRunweaveUpdateArgs } from "./args.mjs";
