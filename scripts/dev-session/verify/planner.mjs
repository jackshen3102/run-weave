...
import { INSTALLED_APP_CONTROL_PATH_PREFIXES } from "../../update/core.mjs";
...
export function verifyPlanner(sourceRoot) {
  ...
  const sharedContract = buildDevSessionPlan({
    sourceRoot,
    changedFiles: ["packages/shared/src/monitoring/runtime.ts"],
  });
  ...
  const betaControlPaths = [
    ...
    "scripts/beta/operations.mjs",
    "scripts/update/operations.mjs",
  ...
  const requestedBetaSlot = buildDevSessionPlan({
    sourceRoot,
    changedFiles: ["scripts/beta/index.mjs"],
    explicitProfile: "beta",
